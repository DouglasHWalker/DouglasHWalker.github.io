    ...
    return (
        <nav>
            ...
            <ul>
                ...
                <li><Link activeClass="active" to="experience" spy={true} smooth={true} offset={-70} duration={1200}>
                    <span className="highlight">02</span> Experience</Link></li>
                <li><Link activeClass="active" to="projects" spy={true} smooth={true} offset={-70} duration={1200}>
                    <span className="highlight">03</span> Projects</Link></li>
                <li><Link activeClass="active" to="contact" spy={true} smooth={true} offset={-70} duration={1200}>
