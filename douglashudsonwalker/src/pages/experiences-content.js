const experiences = [
    {
        ...
        content: [
            'Selected from STEM cohort for full-time internship with largest consulting firm in Adelaide, SA.',
            'Working with cloud delivery team the company facilitates digital transformation and support for companies across the globe, including over 300 firms in the Fortune 500.',
            'Focus on skill development and gaining Microsoft Azure, Google (Tensor & Android), and Oracle (Java & SQL) certifications.',
            'A lesson in the running of large corporation and how to stand out in a large employee base.',
        ],
        tech: [
            'Azure',
            'Java',
