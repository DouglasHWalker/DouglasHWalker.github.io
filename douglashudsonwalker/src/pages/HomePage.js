...
const HomePage = () => {
    return (
        <>
            ...
            <p>More coming soon. Project Page under developement. Please get in touch via LinkedIn @<a style={{ color: "pink" }} href="https://www.linkedin.com/in/douglashudsonwalker" target={"_blank"}>douglashudsonwalker</a></p>
